...
def hash_password(password):
    ...
    return hashlib.md5(password).hexdigest().upper() #使用md5的加密方式，十六进制，大写

#用户信息
class ClientUser(models.Model):
    usernmae = models.CharField(max_length=50,null=False,unique=True)
    ...
    def __str__(self):
        return f'usrename{self.nameuser}'
